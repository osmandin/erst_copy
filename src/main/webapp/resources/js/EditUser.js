// $Id: EditUser.js,v 1.10 2016-10-20 17:21:11-04 ericholp Exp $
...
function askremovedepartment(id) {
    try {
        return confirm("Warning: You are about to disassociate Department id=" + id + " with this user. Proceed?");
    } catch (ex) {
        alert(ex);
    }
    return false;
...
function askdeleteuser(id) {
    try {
        return confirm("Warning: You are about to permanently delete User with id=" + id + ".");
    } catch (ex) {
        alert(ex);
    }
    return false;
